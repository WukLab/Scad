...
import org.apache.openwhisk.core.entity.{ActionLimits, ActivationId, ActivationResponse, EntityName, EntityPath, LogLimit, Parameters, Subject, TimeLimit, WhiskActivation}
