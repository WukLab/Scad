...
def main():
    ...
    cs_succient = df_step1[['ws_order_number', 'ws_warehouse_sk']]
    ...
    cs_sj_f1 = df_step1.loc[df_step1['ws_order_number'].isin(target_order_numbers)]
    print('cs_sj_f1: ', cs_sj_f1.dtypes, cs_sj_f1.shape)

    cs_sj_f2 = cs_sj_f1.loc[cs_sj_f1['ws_order_number'].isin(df_step2.wr_order_number)]
    del cs_sj_f1
    ...
    df_step3 = cs_sj_f2.merge(dd_filtered, left_on='ws_ship_date_sk', right_on='d_date_sk')
    del dd
    del cs_sj_f2
    del dd_select
    del dd_filtered
    ...
    df_step4 = df[df.ca_state == 'IL'.encode()][['ca_address_sk']]
    ...
    df_step5 = merged2[['ws_order_number', 'ws_ext_ship_cost', 'ws_net_profit']]
